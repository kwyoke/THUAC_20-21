...
int main()
{
    ...
    Shader ourShader("shaders/main.vert.glsl", "shaders/main.tcs.glsl", "shaders/main.tes.glsl", "shaders/main.frag.glsl");
    Shader ourShader2("shaders/main.vert.glsl", "shaders/main.frag2.glsl");
    ...
    int width, height;
    unsigned char* image = SOIL_load_image("avatars.jpg", &width, &height, 0, SOIL_LOAD_RGB);
